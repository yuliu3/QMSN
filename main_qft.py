...
chain1 = copy.deepcopy(nums_attempts_grid)*gamma
chain2 = copy.deepcopy(nums_attempts_circle)*gamma
chain3 = copy.deepcopy(nums_attempts_line)*gamma
chain0 = copy.deepcopy(nums_attempts_switch)*gamma
chainb = copy.deepcopy(nums_attempts_benes)*gamma

print(f"time mean = {format(chain0.mean(), '.2e'), format(chainb.mean(), '.2e'), format(chain1.mean(), '.2e'), format(chain2.mean(), '.2e'), format(chain3.mean(), '.2e')}")
